...
var filePath = path.join(__dirname, "..", "sampleasync.txt");
function updateFileSync() {
    console.log("Update file Sync started");
    try {
        fs.appendFileSync(filePath, "Sybc Appended this line.");
    }
    catch (error) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fs_1.promises.appendFile(filePath, "\n Async Update Appended this line.")];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.error(" Error updating file Async:", error_1);
                    return [3 /*break*/, 4];
                case 4:
...
function updateFileStream() {
    return new Promise(function (resolve) {
        ...
        stream.write("\n[Stream Update] Appended this line.");
        stream.end(function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    updateFileSync();
                    return [4 /*yield*/, updateFileAsync()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, updateFileStream()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
